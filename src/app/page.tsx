/* eslint-disable srcnext/next/no-img-element */
import Link from "next/link";
import { Icons } from "src/components/icons";
// import NavMenu from "src/components/layout/navigation/nav-bar/nav-menu";
import { Navbar } from "src/components/layout/navigation";
export default function Home() {
  return (
    <div className="flex flex-col min-h-dvh">
      {/* <header className="px-4 lg:px-6 h-14 flex items-center sticky top-0 backdrop-blur-sm border-b">
        <Link
          href="#"
        ...
        >
          ...
          <span className="sr-only">Rush Store</span>
        </Link>
        <Navbar />
      </header> */}
